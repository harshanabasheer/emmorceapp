...
class _AdminHomeState extends State<AdminHome> {
  List items = [
    GridItems(img: 'images/manageseller.png', name: 'Manage Seller'),
    GridItems(img: 'images/viewproduct.jpeg', name: 'View Product'),
    GridItems(img: 'images/viewuser.jpeg', name: 'View Users'),
    GridItems(img: 'images/vieworder.jpeg', name: 'View Order'),
    GridItems(img: 'images/category.png', name: 'Category'),
  ];
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: ()  {
                switch (index) {
                  case 0:
                    Navigator.push(context, MaterialPageRoute(builder: (context) => ManageSellerPage()));
                    break;
                  case 1:
